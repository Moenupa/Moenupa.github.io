    ...
    <template v-slot:placeholder>
      ...
      >
        ...
        <lottie-player v-else 
          :src="get()" :background="bg()" speed="1" loop autoplay
        ></lottie-player>
      </v-row>
    </template>
  </v-img>
...
export default {
  ...
  data() {
    return {
      std: "https://assets8.lottiefiles.com/datafiles/w8kbBwzPRk7sTCe/data.json",
      tag: "https://assets10.lottiefiles.com/datafiles/FhxLq41wsIS6M7I/data.json",
      ...
      avatar: "https://assets7.lottiefiles.com/private_files/lf30_c0ujh33h.json",
      multiavatar: "https://assets2.lottiefiles.com/packages/lf20_n5icqxkw.json",
  ...
  methods: {
    ...
    bg() {
      ...
      if (typeMap[this.img.type]) return typeMap[this.img.type][this.$vuetify.theme.dark]
      return "transparent"
    }
  }
}
